...
class GenTweet:
    def __init__(self, text:str, imPath:str, name:str, username:str=None, isVerified:bool=False,userid:str=None,likes:int=0,retweet=0,reply=0,created_at:str=None):
        self.text = text
        ...
        arr = [self.likes,self.retweet,self.reply]
        tweetFeatures = ['Retweet', 'Replies', 'Likes']
    ...
    def GetDate(self):
        ...
        x = dateutil.parser.isoparse(self.created_at)
    ...
    def CreateTweet(self):
        ...
        tweet.save("tweet/"+self.userid+".png")
